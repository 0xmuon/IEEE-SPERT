  ...
  return (
    <main className="flex-1">
      ...
      <section className="w-full py-12 md:py-24 lg:py-32">
        <div className="container px-4 md:px-6">
          ...
          <div className="mt-10 bg-primary/10 p-6 rounded-lg border dark:border-gray-700">
            <h3 className="text-2xl font-bold mb-4 text-primary">Accmmodation at Instutute Guest House</h3>
            <ul className="list-disc list-outside pl-6 space-y-2 text-gray-700 dark:text-gray-300">
              ...
              <li>The Guest House is located just outside the campus and is easily accessible by public transport.</li>
                ...
                <li>
                <div className="bg-white dark:bg-gray-900 border border-primary rounded-lg p-4 mt-2 shadow-sm w-fit">
                  <div className="font-semibold text-primary mb-1">Guest House Contact Details:</div>
                  <div>
                  <span className="font-medium">Phone:</span> 0261-2201502
                  </div>
                  <div>
                  <span className="font-medium">Email:</span> guesthouseoffice@svnit.ac.in, svnitguesthouse@gmail.com
                  </div>
                </div>
                </li>
                <li> For more details about the Guest House, please visit <Link href="https://www.svnit.ac.in/web/guesthouse.php" target="_blank" className="text-primary underline">Guest House - SVNIT</Link>. </li>
            </ul>
          </div>


            <div className="mt-10 bg-primary/5 p-6 rounded-lg border border-dashed border-primary dark:border-gray-700">
            <h2 className="text-xl font-semibold mb-2 text-primary">How to Book Accommodation</h2>
          ...
          <h2 className="text-xl font-semibold mt-10 mb-4 text-primary">
          ...
          <div className="mt-10 bg-primary/10 p-6 rounded-lg border dark:border-gray-700">
            <h3 className="text-2xl font-bold mb-4 text-primary">Note:</h3>
            <ul className="list-disc list-outside pl-6 space-y-2 text-gray-700 dark:text-gray-300">
      ...
      <section className="w-full py-6 md:py-10 lg:py-12">
        <div className="container px-4 md:px-6">
          <h2 className="text-3xl font-bold mb-6 text-primary">Nearby Hotels</h2>
        ...
        {/* Ginger Surat */}
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow border p-4 flex flex-col items-center">
          <Image
          ...
          />
          <h3 className="text-xl font-semibold mb-2 text-primary">Ginger Surat</h3>
          <p className="mb-2 text-gray-600 dark:text-gray-400 text-center">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow border p-4 flex flex-col items-center">
          <Image
            ...
            className="rounded-lg object-cover w-full h-40 mb-4"
          />
          <h3 className="text-xl font-semibold mb-2 text-primary">Hotel Shagun</h3>
          <p className="mb-2 text-gray-600 dark:text-gray-400 text-center">
            <span className="font-medium">Distance:</span> ~2.5 km from SVNIT Surat
          </p>
          <Link
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow border p-4 flex flex-col items-center">
          <Image
            ...
            className="rounded-lg object-cover w-full h-40 mb-4"
          />
          <h3 className="text-xl font-semibold mb-2 text-primary">Surat Marriot Hotel</h3>
          <p className="mb-2 text-gray-600 dark:text-gray-400 text-center">
